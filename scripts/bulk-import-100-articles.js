...
const KEYWORD_POOL = [
  { kw: "cloud computing untuk pemula", cat: "Cloud & DevOps" },
  { kw: "belajar cloud computing gratis", cat: "Cloud & DevOps" },
  { kw: "cloud computing untuk mahasiswa", cat: "Cloud & DevOps" },
  { kw: "cloud engineer roadmap 2026", cat: "Cloud & DevOps" },
  { kw: "devops untuk pemula", cat: "Cloud & DevOps" },
  { kw: "belajar devops dari nol", cat: "Cloud & DevOps" },
  { kw: "apa itu kubernetes sederhana", cat: "Cloud & DevOps" },
  { kw: "tutorial docker indonesia", cat: "Cloud & DevOps" },
  { kw: "cara install docker di ubuntu", cat: "Cloud & DevOps" },
  { kw: "docker compose tutorial pemula", cat: "Cloud & DevOps" },
  { kw: "belajar terraform dasar", cat: "Cloud & DevOps" },
  { kw: "terraform vs ansible", cat: "Cloud & DevOps" },
  { kw: "tutorial ansible indonesia", cat: "Cloud & DevOps" },
  { kw: "cara deploy node js ke vps", cat: "Cloud & DevOps" },
  { kw: "deploy website ke cloud gratis", cat: "Cloud & DevOps" },
  { kw: "cloud hosting murah untuk startup", cat: "Cloud & DevOps" },
  { kw: "cara menggunakan aws ec2", cat: "Cloud & DevOps" },
  { kw: "tutorial aws s3 lengkap", cat: "Cloud & DevOps" },
  { kw: "belajar microsoft azure gratis", cat: "Cloud & DevOps" },
  { kw: "google cloud tutorial indonesia", cat: "Cloud & DevOps" },
  { kw: "cloud database gratis terbaik", cat: "Cloud & DevOps" },
  { kw: "free tier cloud terbaik", cat: "Cloud & DevOps" },
  { kw: "cloud storage untuk developer", cat: "Cloud & DevOps" },
  { kw: "belajar ci cd github actions", cat: "Cloud & DevOps" },
  { kw: "github actions untuk pemula", cat: "Cloud & DevOps" },
  { kw: "gitlab ci cd tutorial", cat: "Cloud & DevOps" },
  { kw: "jenkins tutorial lengkap", cat: "Cloud & DevOps" },
  { kw: "cara install jenkins di ubuntu", cat: "Cloud & DevOps" },
  { kw: "devops tools terbaik 2026", cat: "Cloud & DevOps" },
  { kw: "monitoring server open source", cat: "Cloud & DevOps" },
  { kw: "prometheus tutorial indonesia", cat: "Cloud & DevOps" },
  { kw: "grafana dashboard tutorial", cat: "Cloud & DevOps" },
  { kw: "cara monitoring server linux", cat: "Cloud & DevOps" },
  { kw: "nginx reverse proxy tutorial", cat: "Cloud & DevOps" },
  { kw: "apache vs nginx untuk pemula", cat: "Cloud & DevOps" },
  { kw: "load balancer sederhana", cat: "Cloud & DevOps" },
  { kw: "setup ssl gratis lets encrypt", cat: "Cloud & DevOps" },
  { kw: "tutorial linux server pemula", cat: "Cloud & DevOps" },
  { kw: "command linux untuk devops", cat: "Cloud & DevOps" },
  { kw: "cloud security dasar", cat: "Cloud & DevOps" },
  { kw: "keamanan server linux", cat: "Cloud & DevOps" },
  { kw: "backup server otomatis linux", cat: "Cloud & DevOps" },
  { kw: "cara membuat auto deploy website", cat: "Cloud & DevOps" },
  { kw: "deploy react app ke vercel", cat: "Cloud & DevOps" },
  { kw: "deploy next js ke cloudflare", cat: "Cloud & DevOps" },
  { kw: "cloudflare tunnel tutorial", cat: "Cloud & DevOps" },
  { kw: "cloudflare workers tutorial", cat: "Cloud & DevOps" },
  { kw: "belajar serverless computing", cat: "Cloud & DevOps" },
  { kw: "aws lambda tutorial indonesia", cat: "Cloud & DevOps" },
  { kw: "serverless vs traditional server", cat: "Cloud & DevOps" },
  { kw: "cara menggunakan firebase hosting", cat: "Cloud & DevOps" },
  { kw: "firebase vs supabase", cat: "Cloud & DevOps" },
  { kw: "supabase untuk backend website", cat: "Cloud & DevOps" },
  { kw: "backend as a service terbaik", cat: "Cloud & DevOps" },
  { kw: "cara setup redis server", cat: "Cloud & DevOps" },
  { kw: "redis tutorial pemula", cat: "Cloud & DevOps" },
  { kw: "mongodb atlas tutorial", cat: "Cloud & DevOps" },
  { kw: "database cloud gratis", cat: "Cloud & DevOps" },
  { kw: "cara deploy mysql di docker", cat: "Cloud & DevOps" },
  { kw: "postgresql docker tutorial", cat: "Cloud & DevOps" },
  { kw: "belajar helm kubernetes", cat: "Cloud & DevOps" },
  { kw: "minikube tutorial indonesia", cat: "Cloud & DevOps" },
  { kw: "kubernetes untuk pemula", cat: "Cloud & DevOps" },
  { kw: "k3s tutorial ringan", cat: "Cloud & DevOps" },
  { kw: "container orchestration sederhana", cat: "Cloud & DevOps" },
  { kw: "docker swarm tutorial", cat: "Cloud & DevOps" },
  { kw: "virtual machine vs container", cat: "Cloud & DevOps" },
  { kw: "proxmox tutorial indonesia", cat: "Cloud & DevOps" },
  { kw: "belajar virtualisasi server", cat: "Cloud & DevOps" },
  { kw: "cara setup vpn server sendiri", cat: "Cloud & DevOps" },
  { kw: "wireguard tutorial indonesia", cat: "Cloud & DevOps" },
  { kw: "openvpn server tutorial", cat: "Cloud & DevOps" },
  { kw: "cloud gaming server setup", cat: "Cloud & DevOps" },
  { kw: "self hosted aplikasi terbaik", cat: "Cloud & DevOps" },
  { kw: "aplikasi self hosted untuk bisnis", cat: "Cloud & DevOps" },
  { kw: "cara setup nextcloud pribadi", cat: "Cloud & DevOps" },
  { kw: "private cloud sederhana", cat: "Cloud & DevOps" },
  { kw: "openstack tutorial dasar", cat: "Cloud & DevOps" },
  { kw: "hybrid cloud untuk perusahaan kecil", cat: "Cloud & DevOps" },
  { kw: "multi cloud strategy sederhana", cat: "Cloud & DevOps" },
  { kw: "cloud migration checklist", cat: "Cloud & DevOps" },
  { kw: "cara pindah website ke cloud", cat: "Cloud & DevOps" },
  { kw: "hosting docker murah", cat: "Cloud & DevOps" },
  { kw: "vps murah untuk devops", cat: "Cloud & DevOps" },
  { kw: "managed kubernetes murah", cat: "Cloud & DevOps" },
  { kw: "object storage murah terbaik", cat: "Cloud & DevOps" },
  { kw: "s3 compatible storage indonesia", cat: "Cloud & DevOps" },
  { kw: "belajar bash scripting otomatisasi", cat: "Cloud & DevOps" },
  { kw: "shell script untuk admin server", cat: "Cloud & DevOps" },
  { kw: "cron job tutorial linux", cat: "Cloud & DevOps" },
  { kw: "cara setup webhook github", cat: "Cloud & DevOps" },
  { kw: "automated deployment tutorial", cat: "Cloud & DevOps" },
  { kw: "devsecops untuk pemula", cat: "Cloud & DevOps" },
  { kw: "observability dalam devops", cat: "Cloud & DevOps" },
  { kw: "log management open source", cat: "Cloud & DevOps" },
  { kw: "elasticsearch logging tutorial", cat: "Cloud & DevOps" },
  { kw: "loki grafana tutorial", cat: "Cloud & DevOps" },
  { kw: "infrastructure as code indonesia", cat: "Cloud & DevOps" },
  { kw: "roadmap belajar cloud engineer", cat: "Cloud & DevOps" },
  { kw: "peluang kerja cloud computing 2026", cat: "Cloud & DevOps" }
];
...
const COVER_IMAGES = {
  ...
  "Cloud & DevOps": [
    ...
    "https://images.unsplash.com/photo-1597852074816-d933c7d2b988?q=80&w=1000&auto=format&fit=crop",
